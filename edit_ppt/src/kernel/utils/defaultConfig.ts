...
export const fontNameValueList: Record<string, string> = {};
export const fontListMap = {
  font9: 'syht',
  font0: 'yahei',
  font1: 'fzfsjt',
  font2: 'fzhtjt',
...
export function getFontFamilyByFontName(fontFamily: string) {
  ...
  return fontNameValueList[fontFamily] ?? fontFamily;
}

const navigationKeyCode = {
  ArrowDown: 40,
  ArrowRight: 39,
  ArrowLeft: 37,
  ArrowUp: 38,
};
export const navigationKeyCodeList = Object.keys(navigationKeyCode);
const editingKey = {
  Delete: 46,
  Backspace: 8,
};
export const editingKeyList = Object.keys(editingKey);
const optionKeyCode = {
  KeyC: 67,
  KeyX: 88,
  KeyZ: 90,
};
export const optionKeyCodeList = Object.keys(optionKeyCode);

export const defaultAssetStyle: CSSProperties = {
  position: 'absolute',
  top: 0,
  left: 0,
  width: '100%',
