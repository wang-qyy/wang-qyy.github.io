import{d as r,R as T,c as _}from"./client.eC1mBef_.js";import{G as B,I as j,ar as N,aG as A,r as K,n as U}from"./index.CGqtBXJ7.js";import{m as V}from"./ContextIsolator.Cpu1q_tx.js";function G(e){return e.replace(/-(.)/g,(n,t)=>t.toUpperCase())}function W(e,n){A(e,`[@ant-design/icons] ${n}`)}function O(e){return typeof e=="object"&&typeof e.name=="string"&&typeof e.theme=="string"&&(typeof e.icon=="object"||typeof e.icon=="function")}function I(e={}){return Object.keys(e).reduce((n,t)=>{const o=e[t];switch(t){case"class":n.className=o,delete n.class;break;default:delete n[t],n[G(t)]=o}return n},{})}function v(e,n,t){return t?T.createElement(e.tag,{key:n,...I(e.attrs),...t},(e.children||[]).map((o,a)=>v(o,`${n}-${e.tag}-${a}`))):T.createElement(e.tag,{key:n,...I(e.attrs)},(e.children||[]).map((o,a)=>v(o,`${n}-${e.tag}-${a}`)))}function z(e){return B(e)[0]}function P(e){return e?Array.isArray(e)?e:[e]:[]}const q=`
.anticon {
  display: inline-flex;
  align-items: center;
  color: inherit;
