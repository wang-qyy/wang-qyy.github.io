import{r,R as T}from"./index.3NMXXukK.js";import{c as _}from"./clsx.B-dksMZM.js";import{O as B,I as j,a2 as N,au as A,aM as K,u as U}from"./ContextIsolator.YY-pjH8R.js";import{c as V}from"./client.CiOqP2qJ.js";function W(e){return e.replace(/-(.)/g,(n,t)=>t.toUpperCase())}function q(e,n){K(e,`[@ant-design/icons] ${n}`)}function O(e){return typeof e=="object"&&typeof e.name=="string"&&typeof e.theme=="string"&&(typeof e.icon=="object"||typeof e.icon=="function")}function I(e={}){return Object.keys(e).reduce((n,t)=>{const o=e[t];switch(t){case"class":n.className=o,delete n.class;break;default:delete n[t],n[W(t)]=o}return n},{})}function v(e,n,t){return t?T.createElement(e.tag,{key:n,...I(e.attrs),...t},(e.children||[]).map((o,a)=>v(o,`${n}-${e.tag}-${a}`))):T.createElement(e.tag,{key:n,...I(e.attrs)},(e.children||[]).map((o,a)=>v(o,`${n}-${e.tag}-${a}`)))}function z(e){return B(e)[0]}function P(e){return e?Array.isArray(e)?e:[e]:[]}const k=`
.anticon {
  display: inline-flex;
  align-items: center;
  color: inherit;
